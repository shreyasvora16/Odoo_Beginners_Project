...
def json_rpc(url, method, params):
    ...
    response = json.loads(urllib.request.urlopen(req).read().encode().decode("UTF-8"))
...
read_property = call(odoo_url, "object", "execute", db, user_id, password, 'estate.property', 'read', vals)
print(read_property)